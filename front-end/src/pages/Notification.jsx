...
const Notifikasi = () => {
  return (
    <div>
      <div className="md:px-[100px] px-5 py-16 shadow-md z-10 bg-customLime01 relative">
        {/* LINK KEMBALI */}
      ...
      <div>
        <div className="z-20 flex flex-col md:w-[70vw] w-[80vw] mx-auto rounded-[20px] shadow-2xl relative top-[-65px]">
          <div className="text-center bg-emerald-500 text-white p-5 rounded-t-[20px]">
          ...
          <div className="h-[300px] z-20 md:p-10 p-2">
            ...
            <div className="flex justify-between mt-2">
              ...
              <div className="flex gap-5 leading-snug">
                {/* logo Bell */}
                <div className="md:w-[20px] md:h-[20px] w-[15px] h-[15px] rounded-full bg-emerald-500 relative flex-shrink-0 mt-1">
                  <BellIcon className="text-white md:w-[15px] w-[10px] mx-auto absolute top-[2px] left-[2.5px]" />
                </div>
                {/* Judul */}
                <div>
                  <h1 className="font-bold text-customGreen01 ">Promosi</h1>
                  {/* Berita */}
            ...
            <div className="flex justify-between mt-2">
              ...
              <div className="flex gap-5 leading-snug">
                ...
                {/* Judul */}
                <div>
                  <h1 className="font-bold text-customGreen01 ">Notifikasi</h1>
                  {/* Berita */}
                  <h2 className="font-bold text-[10px]">
