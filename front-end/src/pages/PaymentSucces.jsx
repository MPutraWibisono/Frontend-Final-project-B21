  ...
  return (
    <div>
      ...
      <div className=" items-center w-full text-center mb-10">
        <h1 className="font-bold text-emerald-500 text-[64px]">Selamat!</h1>
        <img
          src="/berhasilBayar.svg"
          width={200}
          height={200}
        ...
        <button
          href=""
          className="bg-emerald-500 text-white px-[100px] py-2 mb-10 rounded-[15px]"
        >
          <h2 className="font-bold"> Mulai Belajar</h2>
        </button>
        <Link to="/" className="font-semibold text-darkBlue03">
