  ...
  return (
    <>
        ...
        <div className=" m-auto ">
          <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12">
            <div className=" col-span-4 lg:col-span-7">
              <img src="../../public/belajar.jpg" alt="belajar-kelompok" />
            </div>
            <div className="col-span-4 lg:col-span-5 bg-gradient-to-b from-white from-5% via-lime-100 via-50% to-green-300 to-80% flex justify-center items-center flex-col ">
              <p className="font-sans">Belajar dari Praktisi Terbaik</p>
      ...
      <div className="glide-03 relative w-full">
        <div className="flex">
          <span>Kategori Belajar</span>
          <span className="ms-auto text-sky-600">Lihat semua</span>
        </div>
        {/*    <!-- Slides --> */}
        <div className="overflow-hidden" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <a href="#">
                <div className="h-2/3 lg:max-h-80 overflow-hidden">
                  <img
